...
<div class="layui-form" lay-filter="goods_type_form" id="goods_type_form" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="type_name" lay-verify="required" lay-reqtext="请输入商品分类名称" placeholder="请输入商品分类名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="type_code" lay-verify="required" lay-reqtext="请输入商品分类编码" placeholder="请输入商品分类编码" autocomplete="off" class="layui-input">
        </div>
    </div>
