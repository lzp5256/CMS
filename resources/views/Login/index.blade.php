...
<script src="{{URL::asset('lib/jquery-3.4.1/jquery-3.4.1.min.js')}}" charset="utf-8"></script>
<script src="{{URL::asset('lib/layui-v2.5.4/layui.js')}}" charset="utf-8"></script>
<script src="{{URL::asset('lib/jq-module/jquery.particleground.min.js')}}" charset="utf-8"></script>
<script>
